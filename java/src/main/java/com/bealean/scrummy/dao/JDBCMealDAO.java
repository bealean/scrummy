...
public class JDBCMealDAO implements MealDAO {
    ...
    @Override
    public List<Meal> getMealsByDailyPlan(long dailyPlanId) throws RecipeNotFoundException {
    ...
    @Override
    public Meal getMealById(long mealIdParam) throws RecipeNotFoundException {
        Meal meal = null;
